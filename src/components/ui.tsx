...
const VARIANTS: Record<ButtonVariant, string> = {
  primary:
    "bg-brand text-white border border-brand hover:bg-[#f05a24] hover:border-[#f05a24] shadow-[0_1px_2px_rgba(23,23,23,0.06)] hover:shadow-[0_8px_20px_-8px_rgba(255,107,53,0.55)]",
